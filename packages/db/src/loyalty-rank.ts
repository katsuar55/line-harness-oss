...
export const NATURISM_RANK_DEFS: readonly LoyaltyRankDef[] = [
  { id: 'regular', name: 'レギュラー', order: 0, minTrailing12moJpy: 0, discountPercent: 0, badgeEmoji: '🌱', badgeColor: '#9CA3AF' },
  { id: 'bronze', name: 'ブロンズ', order: 1, minTrailing12moJpy: 1, discountPercent: 2, badgeEmoji: '🥉', badgeColor: '#CD7F32' },
  { id: 'silver', name: 'シルバー', order: 2, minTrailing12moJpy: 12000, discountPercent: 4, badgeEmoji: '🥈', badgeColor: '#C0C0C0' },
  { id: 'gold', name: 'ゴールド', order: 3, minTrailing12moJpy: 24000, discountPercent: 6, badgeEmoji: '🥇', badgeColor: '#FFD700' },
  { id: 'platinum', name: 'プラチナ', order: 4, minTrailing12moJpy: 45000, discountPercent: 8, badgeEmoji: '💎', badgeColor: '#0ABAB5' },
];
