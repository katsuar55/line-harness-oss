...
<head>
  ...
  <style>
    *{-webkit-tap-highlight-color:transparent}
    ...
    .btn-pill{border:1.5px solid #cfe6e6;background:#fff;color:#0f766e;font-size:12px;font-weight:600;padding:6px 14px;border-radius:9999px}
    .btn-pill.is-active{background:#0f766e;color:#fff;border-color:#0f766e}
    ...
    .badge-on{background:#eef7f7;color:#0f766e}
...
<body class="min-h-screen pb-20">
  ...
  <header class="sticky top-0 z-50" style="background:rgba(255,255,255,.88);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-bottom:1px solid rgba(0,0,0,.06)">
    <div class="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
      ...
      <h1 class="text-base font-bold tracking-tight" style="color:#0f766e">&#x1F4E6; 再購入リマインダー</h1>
