...
/**
 * リッチメニュー画像の R2 key（2500×1686 JPEG、本番デザイン）。
 * 画像は R2 (IMAGES bucket) に保存し setup-naturism が fetch → LINE へ upload する。
 * worker bundle に base64 を焼き込まない（bundle 肥大 + free 枠 1MB gzip 制限の回避）。
