...
export const DEFAULT_FAQ_ENTRIES: ReadonlyArray<FaqEntry> = [
  ...
  { category: 'allergy', question: 'アレルギーは？', answer: 'Pinkはオレンジ・キウイフルーツ・バナナ・リンゴ・大豆・ゴマ・カシューナッツを含みます。Premiumは大豆を含みます。Blueは特定原材料8品目・推奨表示20品目を使用していません（製造工程上の混入の可能性は否定できません）' },
  ...
  { category: 'usage', question: 'お腹がゆるくなった', answer: '体質や体調により一時的にゆるくなる場合があります。粒数を減らしてお試しください。続く場合は使用を中止し医師へ' },
  { category: 'product', question: 'ヴィーガン対応？', answer: '原材料表示に動物性原料の記載はありません。ただしヴィーガン認証は取得しておらず、製造工程や原料の培地までは保証しかねます。厳密な確認が必要な場合は各商品ページの原材料表示をご案内する' },
