...
| Q3 | 続けるうえで重視したいのは? | A: 美容も一緒に考えたい / B: 食事のバランスを意識したい / C: 全体ケア / D: 特になし |
...
| Q2 | C 健康 | +2 | +1 | 0 |
| Q2 | D 美容 | 0 | +3 | 0 |
| Q3 | A 美容も一緒に考えたい | 0 | +3 | 0 |
| Q3 | B 食事のバランスを意識したい | 0 | +3 | 0 |
| Q3 | C 全体ケア | 0 | 0 | +2 |
| Q3 | D 特になし | +2 | 0 | 0 |
...
2. scoring rule は妥当か? (= 例: Q3-A「美容も一緒に考えたい」 = Pink +3 は強すぎ? ※2026-08-03 文言改定済)
